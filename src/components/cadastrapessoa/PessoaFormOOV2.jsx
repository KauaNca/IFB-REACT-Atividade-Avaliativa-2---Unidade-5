...
export default function PessoaFormOOV2() {
  ...
  {
    /*
    O useParams() é um hook do react-router-dom que devolve um objeto com os parâmetros definidos na rota.
  */
  }
      ...
      if (pessoa) {
        ...
        if (tipoParam === 'PF') {
          ...
          valores.ie = {
            numero: ieObj.numero || '',
            estado: ieObj.estado || '',
            dataRegistro: ieObj.dataRegistro ? dayjs(ieObj.dataRegistro) : null,
          };
        }
